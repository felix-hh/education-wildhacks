# -*- coding: utf-8 -*-
"""data_pipeline_AWS_transcript.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LuMMhJXFzkNcbpvIeMzp--D_342R-ACp
"""

pip install oauthlib requests requests-oauthlib boto3

"""This data pipeline pulls lecture recordings from Panopto via the Panopto REST API, then uses AWS Transcript to perform speech to text conversion. This is then pushed to AWS s3 for further processing."""

# Replace with your Panopto access id and secret
client_id = 'YOUR-CLIENT-ID'
client_secret = 'YOUR-CLIENT-SECRET'
panopto_server = '<YOUR-INSTITUTION-DOMAN>.panopto.com'
...
panopto_server = 'northwestern.hosted.panopto.com/'
session_id = 'your_session_id'
output_file = 'video.mp4'

# Step 1: Obtain an Access Token
panopto_auth = PanoptoOAuth2(panopto_server, client_id, client_secret, ssl_verify=False)
access_token = panopto_auth.get_access_token_authorization_code_grant()

# Step 2: Get the Video Session Information
session_url = f'https://{panopto_server}Panopto/api/v1/sessions/{session_id}'
headers = {
    'Authorization': f'Bearer {access_token}',
}
response = requests.get(session_url, headers=headers)
response.raise_for_status()
video_url = response.json()['MP4Url']
...
if __name__ == '__main__':
    video_file_url = "s3://wildhacks2023/jay.mp4"
    ...
    transcribe = boto3.client(
        ...
        region_name='us-east-2'  # Replace 'us-west-2' with your desired region
    )

    # Start a new transcription job
    job_name = "transcribe_jay_job"+f'{np.random.randint(999999)}'
    transcribe.start_transcription_job(
        TranscriptionJobName=job_name,
        Media={'MediaFileUri': video_file_url},
        MediaFormat='mp4',
        LanguageCode='en-US',
        OutputBucketName='wildhacks2023'
    )

    # Check the status of the transcription job until it's completed
    while True:
